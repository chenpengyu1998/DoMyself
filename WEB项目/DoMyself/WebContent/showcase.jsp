...
<main>
  ...
  <section class="content">
    <div class="works">
      ...
      <!--图区-->
  <c:forEach var="j" items="${pics}">
  
      <div class="grid-item-double one">
        <figure class="reveal-effect se2-white wow perspective-box">
        <img src="${j.pictureurl}" alt="ERROR">
          <figcaption><a data-fancybox="gallery" href="${j.pictureurl}">
            ...
            <small>${j.picturemessage}</small> </a> </figcaption>
        </figure>
        <a href="showcaseDetails?mid=${j.messageid }">查看详情</a>
      </div>
  </c:forEach>
