...
public class SendEmail {
	//发送邮件邮箱的的用户名
	private String postUsername="m15226560812@163.com";
	
	//发送邮件邮箱的密码
	private String postPassword="cpy196812088235";
	
	//发送邮件的主题
	private static String sendSubject="DoMyslef网站发来的申请";
	
	//发送邮件的正文
	private static String sendContent="欢迎加入DoMyselfTeam组织， ";
	...
	//收件人的邮箱地址
	private String acceptEmailAddress="1145693809@qq.com";
